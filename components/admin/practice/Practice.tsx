...
export default function Practice() {
    ...
    return (
        <div className="text-slate-300">
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-24 px-6 text-center rounded- border border-[var(--text-color)] bg-[var(--site-bg)] min-h-[90dvh]">
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-slate-800">
                                    {practices.map((practice) => (
                                        <tr key={practice.id} className="hover:bg-[var(--text-color)]/20 transition-colors group">
                                            <td className="p-4 font-medium text-[var(--text-color)] whitespace-nowrap">
                                                {practice.legal_name || 'N/A'}
                                            </td>
                                            <td className="p-4 text-[var(--text-color)] text-sm">{practice.abbreviated_name}</td>
                                            <td className="p-4 text-[var(--text-color)] text-sm">{practice.primary_email}</td>
                                            <td className="p-4 text-[var(--text-color)] text-sm">{practice.city}</td>
