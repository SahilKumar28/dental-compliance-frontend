...
export default function PracticeModal({ isOpen, onClose, onSubmit, practice = null }: PracticeModalProps) {
    ...
    useEffect(() => {
        if (practice) {
            ...
            let colorHex = '#6366f1';
            if (practice.primary_color) {
                colorHex = typeof practice.primary_color === 'string'
                    ? practice.primary_color
                    : practice.primary_color.hex || '#6366f1'; // fallback for old data
            }

            let colorHex1 = '#000000';
            if (practice.secondary_color) {
                colorHex1 = typeof practice.secondary_color === 'string'
                    ? practice.secondary_color
                    : practice.secondary_color.hex || '#000000';
            }
